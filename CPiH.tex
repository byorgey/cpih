...
XXX lists as control vs lots of small list data structures
...
structure.  This is not as fast as a hash table, but quite fast in
practice, and provides a much richer API than a hash-based data
structure. (The \pkg{unordered-containers} package---which is available
in the Open Kattis test environment---does provide \h{Data.HashSet}, but
it's rarely needed.)

It is worth being familiar with
